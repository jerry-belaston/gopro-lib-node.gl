...
static const struct node_param texteffect_params[] = {
    ...
    {"alpha",        NGLI_PARAM_TYPE_NODE, OFFSET(alpha_node),
                     .node_types=FLOAT_NODE_TYPES,
                     .flags=NGLI_PARAM_FLAG_DOT_DISPLAY_FIELDNAME,
    ...
    {"stroke_width", NGLI_PARAM_TYPE_NODE, OFFSET(stroke_width_node),
                     .node_types=FLOAT_NODE_TYPES,
                     .flags=NGLI_PARAM_FLAG_DOT_DISPLAY_FIELDNAME,
                     .desc=NGLI_DOCSTRING("characters stroke width")},
    {"stroke_color", NGLI_PARAM_TYPE_NODE, OFFSET(stroke_color_node),
                     .node_types=VEC4_NODE_TYPES,
                     .flags=NGLI_PARAM_FLAG_DOT_DISPLAY_FIELDNAME,
                     .desc=NGLI_DOCSTRING("characters stroke color")},
    {"glow_width",   NGLI_PARAM_TYPE_NODE, OFFSET(glow_width_node),
                     .node_types=FLOAT_NODE_TYPES,
                     .flags=NGLI_PARAM_FLAG_DOT_DISPLAY_FIELDNAME,
                     .desc=NGLI_DOCSTRING("characters stroke width")},
